...
#ifdef CONFIG_KEXEC_CORE
void send_kdump_ipcmsg(u32 fault_code, u32 strategy_code)
{
	int session_id;
	int ret;
	ipc_msg msg = {
	...
	session_id = ipc_init(IPC_CORE_R5_0, IPC_CORE_ARM5, NULL); /* g_pdev_ipc from bst_ddr_ecc_int.c */
...
void crash_smp_send_stop(void)
{
	...
	send_kdump_ipcmsg(0xA00D01,0x03);
	/*
