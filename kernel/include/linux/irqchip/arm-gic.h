...
// add by xiangning 2021/07/26
#define GICD_INIT_CAN_PRI		0x20
#define GICD_INIT_CAN0_PRI_X16	((GICD_INIT_CAN_PRI << 24) |\
								(GICD_INT_DEF_PRI_X4 << 16)|\
								(GICD_INT_DEF_PRI_X4 << 8)|\
								GICD_INT_DEF_PRI_X4)
#define GICD_INIT_CAN1_PRI_X16	((GICD_INT_DEF_PRI_X4 << 24) |\
								(GICD_INT_DEF_PRI_X4 << 16)|\
								(GICD_INT_DEF_PRI_X4 << 8)|\
								GICD_INIT_CAN_PRI)
