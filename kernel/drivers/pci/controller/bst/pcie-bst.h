...
#define PCIE_ATU_REGION_INDEX4		0x4
...
#define PORT_LOGIC_SAFETY_MASK  0x960
#define PORT_LOGIC_SAFETY_STATU 0x964
...
#define A1000_PCIE_HC_NUM       2

#define PCIE_CAP_REG_BASE       0x70
#define DEV_CTRL_DEV_STAT       0x8
#define LINK_CTRL_AND_SATA      0x10

#define PCIE_HDR_STAT_CMD_REG   0x4
struct pcie_port;
struct dw_pcie;
struct dw_pcie_ep;
...
struct pcie_port {
	...
	u32			io_size;
	u64			mem_base;
	void __iomem    *mem_map_va;
	u32			mem_size;
	u32		    ob_mem_def;
	u32         ob_mem_size;
	struct resource		*mem;
	int			irq[A1000_PCIE_COM_INT];
...
#if (defined CONFIG_PCIE_BST_HOST) || (defined CONFIG_PCIE_BST_HOST_MODULE)
...
#if (defined CONFIG_PCIE_BST_EP) || (defined CONFIG_PCIE_BST_EP_MODULE)
...
void pcie_ltssm_trainning(struct dw_pcie *pci);
