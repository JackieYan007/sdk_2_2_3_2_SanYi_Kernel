 ...
 */
struct mve_fw_instance *mve_fw_load(struct mve_mmu_ctx *ctx, struct mve_fw_secure_descriptor *fw_secure_desc,
                                    const char *role, int ncores);
 ...
 */
struct mve_fw_version *mve_fw_get_version(struct mve_fw_instance *inst);
