...
{
    mve_buffer_handle_t buffer_id;        /**< Unique buffer ID */
...
{
    struct mve_mem_virt_region region;         /**< Defines the mapping in MVE virtual
                                                *   address space */
    ...
    uint32_t offset_in_page;                   /**< Offset in bytes to the start
                                                *   of the buffer. 0 if the allocation
                                                *   is page aligned. */
};
