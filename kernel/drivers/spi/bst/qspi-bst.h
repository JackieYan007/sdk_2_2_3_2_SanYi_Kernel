...
static inline u64 dw_qspi_readq(struct dw_qspi *dws, u32 offset)
{
	return __raw_readq(dws->regs + offset);
}
...
static inline void dw_qspi_writeq(struct dw_qspi *dws, u32 offset, u64 val)
{
	__raw_writeq(val, dws->regs + offset);
}
...
static inline u64 dw_qspi_read_io_reg64(struct dw_qspi *dws, u32 offset)
{
	return dw_qspi_readq(dws, offset);
}

static inline void dw_qspi_write_io_reg64(struct dw_qspi *dws, u32 offset, u64 val)
{
	dw_qspi_writeq(dws, offset, val);
}
