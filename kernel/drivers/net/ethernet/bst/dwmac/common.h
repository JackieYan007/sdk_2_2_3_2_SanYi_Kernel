...
/* PCS defines */
#define BSTGMAC_PCS_RGMII	(1 << 0)
#define BSTGMAC_PCS_SGMII	(1 << 1)
#define BSTGMAC_PCS_TBI		(1 << 2)
#define BSTGMAC_PCS_RTBI		(1 << 3)
