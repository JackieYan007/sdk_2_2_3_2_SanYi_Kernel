...
* Based on a patch from dw_app_timer.c
...
int clocksource_pr_debug_test(void)
{
	pr_debug("/****** clocksource: this is pr_debug in module clocksource. ******/\n");
	return 0;
}
EXPORT_SYMBOL(clocksource_pr_debug_test);
