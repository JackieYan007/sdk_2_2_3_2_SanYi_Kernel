...
{
	nc_video_s *pVdAutoInfo = (nc_video_s*)pParam;

	unsigned char dev       = 0;
	unsigned char ch        = pVdAutoInfo->Chn;
	unsigned char vfc_Value = 0;

	gpio_i2c_write(jaguar1_i2c_addr[dev], 0xFF, 0x01);
	vfc_Value = gpio_i2c_read(jaguar1_i2c_addr[dev], 0x10 + (0x20 * ch));
	pVdAutoInfo->Vfc = vfc_Value;
}
...
void jaguar1_video_auto_novideo_set( void *pParam )
{
	...
	unsigned char dev     = 0;
	unsigned char ch      = pVdAutoInfo->Chn;
	unsigned char vseq[4] = { 0x33, 0x22, 0x11, 0x00 };

	gpio_i2c_write(jaguar1_i2c_addr[dev], 0xFF, 0x13);
	gpio_i2c_write(jaguar1_i2c_addr[dev], 0x1F, 0x23);
	gpio_i2c_write(jaguar1_i2c_addr[dev], 0x30, 0xFF);
	gpio_i2c_write(jaguar1_i2c_addr[dev], 0x31, 0xFF);
	gpio_i2c_write(jaguar1_i2c_addr[dev], 0x32, 0xFF);

	gpio_i2c_write(jaguar1_i2c_addr[dev], 0xFF, 0x01);
	gpio_i2c_write(jaguar1_i2c_addr[dev], 0xc0 + (ch*0x02), vseq[ch]);
	gpio_i2c_write(jaguar1_i2c_addr[dev], 0xc1 + (ch*0x02), vseq[ch]);
	gpio_i2c_write(jaguar1_i2c_addr[dev], 0xC8 + ch, 0x30);


	gpio_i2c_write(jaguar1_i2c_addr[dev], 0xFF, 0x05+ch);
	gpio_i2c_write(jaguar1_i2c_addr[dev], 0x82, 0xFF);
	gpio_i2c_write(jaguar1_i2c_addr[dev], 0xB8, 0xB9);
...
void jaguar1_video_auto_video_set( void *pParam )
{
	...
	unsigned char dev     = 0;
	unsigned char ch      = pVdAutoInfo->Chn;
	unsigned char vseq[4] = { 0x00, 0x11, 0x22, 0x33 };

	gpio_i2c_write(jaguar1_i2c_addr[dev], 0xFF, 0x13);
	gpio_i2c_write(jaguar1_i2c_addr[dev], 0x1F, 0x63);
	gpio_i2c_write(jaguar1_i2c_addr[dev], 0x30, 0x00);
	gpio_i2c_write(jaguar1_i2c_addr[dev], 0x31, 0xFF);
	gpio_i2c_write(jaguar1_i2c_addr[dev], 0x32, 0xFF);
	...
	gpio_i2c_write(jaguar1_i2c_addr[dev], 0xc0 + (ch*0x02), vseq[ch]);
	gpio_i2c_write(jaguar1_i2c_addr[dev], 0xc1 + (ch*0x02), vseq[ch]);
	gpio_i2c_write(jaguar1_i2c_addr[dev], 0xC8 + ch, 0x00);


	gpio_i2c_write(jaguar1_i2c_addr[dev], 0xFF, 0x05+ch);
	gpio_i2c_write(jaguar1_i2c_addr[dev], 0x82, 0x00);
	gpio_i2c_write(jaguar1_i2c_addr[dev], 0xB8, 0x39);
