...
#if (NVP2650D_I2C==1)
#define _IMX274_RD( addr, reg ) _I2C_ReadWordEx( g_fd_i2c, addr, reg, 2, 1 )
#define _IMX274_WR( addr, reg, data ) _I2C_SendWordEx( g_fd_i2c, addr, reg, data, 2, 1)
#else
