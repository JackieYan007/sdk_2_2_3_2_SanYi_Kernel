...
#define BST_PIN_MUX_NUM 2


#define TOP_MUX_GROUP(pname, mux0, mux1, pmm, poff,cfg,cfgoff,ie,ieoff)        \
	{							\
		.name = #pname,			\
        .pins = pname##_pins,   \
...
#define AON_MUX_GROUP(pname, mux0, mux1, pmm, poff,cfg,cfgoff,ie,ieoff)        \
    {                           \
        .name = #pname,         \
        .pins = pname##_pins,   \
        .npins = ARRAY_SIZE(pname##_pins),  \
