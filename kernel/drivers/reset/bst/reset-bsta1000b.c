 ...
 */
void __iomem *a1000b_rst_addr[5];
...
static bst_reset_map bst_rst_maps[] = {
    /* TOP_CRM_REG_R_TOP_CRM_BLOCK_SW_RST0 */
    [RST_CODEC_SW]          = { NULL, 3, ZERO_ASSERT_ONE_DEASSERT },
    [RST_CPU_SW]            = { NULL, 2, ZERO_ASSERT_ONE_DEASSERT },
    [RST_LPDDR0_SW]         = { NULL, 1, ZERO_ASSERT_ONE_DEASSERT },
    [RST_LPDDR1_SW]         = { NULL, 0, ZERO_ASSERT_ONE_DEASSERT },

        /* TOP_CRM_REG_R_TOP_CRM_BLOCK_SW_RST1 */
    [RST_USB3_SW]           = { NULL, 16, ZERO_ASSERT_ONE_DEASSERT },
    [RST_USB2_SW]           = { NULL, 15, ZERO_ASSERT_ONE_DEASSERT },
    [RST_ISP_SW]            = { NULL, 14, ZERO_ASSERT_ONE_DEASSERT },
    [RST_NET_SW]            = { NULL, 13, ZERO_ASSERT_ONE_DEASSERT },
    [RST_CV_SW]             = { NULL, 12, ZERO_ASSERT_ONE_DEASSERT },
    [RST_VSP_SW]            = { NULL, 11, ZERO_ASSERT_ONE_DEASSERT },
    [RST_PCIE_SW]           = { NULL, 10, ZERO_ASSERT_ONE_DEASSERT },
    [RST_GPU_SW]            = { NULL,  9, ZERO_ASSERT_ONE_DEASSERT },
    [RST_GDMA_SW]           = { NULL,  8, ZERO_ASSERT_ONE_DEASSERT },
    [RST_MIPI0_SW]          = { NULL,  7, ZERO_ASSERT_ONE_DEASSERT },
    [RST_MIPI1_SW]          = { NULL,  6, ZERO_ASSERT_ONE_DEASSERT },
    [RST_MIPI2_SW]          = { NULL,  5, ZERO_ASSERT_ONE_DEASSERT },
    [RST_MIPI3_SW]          = { NULL,  4, ZERO_ASSERT_ONE_DEASSERT },
    [RST_GMAC0_SW]          = { NULL,  3, ZERO_ASSERT_ONE_DEASSERT },
    [RST_GMAC1_SW]          = { NULL,  2, ZERO_ASSERT_ONE_DEASSERT },
    [RST_SDEMMC0_SW]        = { NULL,  1, ZERO_ASSERT_ONE_DEASSERT },
    [RST_SDEMMC1_SW]        = { NULL,  0, ZERO_ASSERT_ONE_DEASSERT },   
    ...
    [RST_LSP0_CAN_FD0_SW]   = { NULL,  9, ZERO_ASSERT_ONE_DEASSERT },
    [RST_LSP0_CAN_FD1_SW]   = { NULL, 13, ZERO_ASSERT_ONE_DEASSERT },
    [RST_LSP0_TIMER0_SW]    = { NULL, 10, ZERO_ASSERT_ONE_DEASSERT },
    [RST_LSP0_TIMER1_SW]    = { NULL, 11, ZERO_ASSERT_ONE_DEASSERT },
    ...
    [RST_LSP1_CAN_FD_SW]    = { NULL,  8, ZERO_ASSERT_ONE_DEASSERT },
...
static int bsta1000b_reset_probe(struct platform_device *pdev)
{
    struct resource *res;
    u32 i;
    ...
    for(i = TOP_CRM_BLOCK_SW_RST0; i <= LSP1_RST_CTRL_REG; i++) {
        ...
        a1000b_rst_addr[i] = ioremap(res->start, resource_size(res));
        if (! a1000b_rst_addr[i]) {
...
static const struct of_device_id bsta1000b_reset_dt_ids[] = {
	{ .compatible = "bst,a1000b-rstc", },
	{ /* sentinel */ },
};

static struct platform_driver bsta1000b_reset_driver = {
	.probe	= bsta1000b_reset_probe,
	.driver = {
		.name		= KBUILD_MODNAME,
		.of_match_table	= bsta1000b_reset_dt_ids,
	},
};

//builtin_platform_driver(bsta1000_reset_driver);
static int __init bsta1000b_reset_init(void)
{
	return platform_driver_register(&bsta1000b_reset_driver);
}
arch_initcall(bsta1000b_reset_init);


MODULE_DESCRIPTION("BST A1000B reset driver");
